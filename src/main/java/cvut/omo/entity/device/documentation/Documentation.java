...
public class Documentation {
     ...
     *
     * @throws IOException {@link  FileManager}
     */
    public void generateDocumentation() throws IOException {
        ...
        final String text = "This is very clever documentation for the device: " + nameDevice + " you just broke.\n It turned out that your device has a state of damage: ";
        ...
        FileManager.generateNewDocumentation(nameOfDocumentation, res.toString());
    }
}
